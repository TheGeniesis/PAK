...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("background-color: rgb(255, 248, 249);")
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.page_main = QtWidgets.QStackedWidget(self.centralwidget)
        self.page_main.setGeometry(QtCore.QRect(160, 20, 891, 681))
...
"font: bold14px;")
        ...
        self.main_training_today.setGeometry(QtCore.QRect(110, 220, 67, 17))
        font = QtGui.QFont()
        ...
        self.label_3.setGeometry(QtCore.QRect(650, 120, 191, 71))
...
"font: bold14px;")
        ...
        self.label_2.setGeometry(QtCore.QRect(350, 120, 191, 71))
...
"font: bold14px;")
        ...
        self.main_training_this_week.setGeometry(QtCore.QRect(410, 220, 67, 17))
        font = QtGui.QFont()
        font.setFamily("Segoe WP")
        font.setBold(False)
        font.setItalic(False)
        ...
        self.main_training_this_week.setStyleSheet("border-style: outset;\n"
"border-width: 1px;\n"
"border-radius: 10px;")
        ...
        self.main_training_this_month.setGeometry(QtCore.QRect(710, 220, 67, 17))
        font = QtGui.QFont()
        font.setFamily("Segoe WP")
        font.setBold(False)
        font.setItalic(False)
        ...
        self.main_text.setGeometry(QtCore.QRect(270, 20, 321, 51))
...
"font: bold14px;")
        ...
        self.label_5.setGeometry(QtCore.QRect(300, 490, 281, 61))
        font = QtGui.QFont()
        font.setFamily("Segoe WP")
...
"border-color: black;")
        ...
        self.b_video_exercise_yes.setGeometry(QtCore.QRect(340, 570, 91, 25))
        self.b_video_exercise_yes.setStyleSheet("border-style: outset;\n"
"border-width: 2px;\n"
"border-radius: 10px;")
        ...
        self.b_video_exercise_no.setGeometry(QtCore.QRect(450, 570, 89, 25))
        self.b_video_exercise_no.setStyleSheet("border-style: outset;\n"
"border-width: 2px;\n"
"border-radius: 10px;")
        self.b_video_exercise_no.setObjectName("b_video_exercise_no")
        self.video_widget = QtWidgets.QWidget(self.view_video)
        self.video_widget.setGeometry(QtCore.QRect(110, 20, 671, 451))
...
"border-radius: 10px;")
        ...
        self.video_box.setGeometry(QtCore.QRect(40, 30, 601, 221))
...
"border-radius: 0px;")
        ...
        self.label_7.setGeometry(QtCore.QRect(140, 210, 611, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe WP")
        font.setPointSize(12)
        font.setBold(False)
...
"border-radius: 10px;")
        ...
        self.f_exercise_declined_comment.setGeometry(QtCore.QRect(140, 260, 611, 181))
...
"background-color: rgb(255, 255, 255);")
        ...
        self.b_exercise_declined_confirm.setGeometry(QtCore.QRect(660, 450, 91, 25))
        font = QtGui.QFont()
        font.setFamily("Segoe WP")
        font.setBold(False)
        font.setItalic(False)
        ...
        self.b_exercise_declined_confirm.setStyleSheet("border-style: outset;\n"
"border-width: 2px;\n"
"border-radius: 10px;")
        ...
        self.b_exercise_grade_1.setGeometry(QtCore.QRect(140, 290, 71, 71))
        font = QtGui.QFont()
        font.setFamily("Segoe WP")
        font.setPointSize(12)
        font.setBold(False)
...
"image: url(:/faces/png/dissapointed.png);")
        ...
        self.b_exercise_grade_5.setGeometry(QtCore.QRect(690, 290, 71, 71))
        font = QtGui.QFont()
        font.setFamily("Segoe WP")
        font.setPointSize(12)
        font.setBold(False)
...
"border-color: black;")
        ...
        self.label_4.setGeometry(QtCore.QRect(270, 20, 321, 51))
...
"border-color: black;")
        ...
        self.label_9.setGeometry(QtCore.QRect(310, 90, 241, 21))
        font = QtGui.QFont()
        font.setFamily("Segoe WP")
        font.setPointSize(12)
        font.setBold(False)
...
"border-color: black;")
        ...
        self.f_settings_check_absence.setGeometry(QtCore.QRect(310, 170, 241, 23))
        font = QtGui.QFont()
        font.setFamily("Segoe WP")
        font.setPointSize(12)
        font.setBold(False)
...
"border-color: black;")
        ...
        self.f_settings_start_with_os.setGeometry(QtCore.QRect(310, 220, 241, 23))
        font = QtGui.QFont()
        font.setFamily("Segoe WP")
        font.setPointSize(12)
        font.setBold(False)
...
"border-color: black;")
        ...
        self.b_settings_confirm.setGeometry(QtCore.QRect(380, 290, 89, 25))
        font = QtGui.QFont()
        font.setFamily("Segoe WP")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.b_settings_confirm.setStyleSheet("border-width: 1px;\n"
"border-radius: 10px;\n"
"border-color: black;")
        ...
        self.f_settings_exercise_interval.setGeometry(QtCore.QRect(330, 120, 201, 16))
        ...
        self.label_6.setGeometry(QtCore.QRect(270, 20, 321, 51))
...
"border-color: black;")
        ...
        self.summary_calendar.setGeometry(QtCore.QRect(80, 80, 741, 371))
        font = QtGui.QFont()
        font.setFamily("Segoe WP")
        font.setBold(False)
        font.setItalic(False)
...
"border-color: black;")
        ...
        self.label_10.setGeometry(QtCore.QRect(370, 470, 131, 41))
        font = QtGui.QFont()
        font.setFamily("Segoe WP")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.label_10.setStyleSheet("border-width: 1px;\n"
"border-radius: 10px;")
        self.label_10.setObjectName("label_10")
        self.summary_exercises_amount = QtWidgets.QLabel(self.view_summary)
        self.summary_exercises_amount.setGeometry(QtCore.QRect(410, 520, 51, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe WP")
        font.setBold(False)
        font.setItalic(False)
        ...
        self.summary_exercises_amount.setStyleSheet("border-width: 1px;\n"
"border-radius: 10px;")
...
"background-color: rgb(255, 255, 255);")
        ...
        self.page_main.setCurrentIndex(3)
